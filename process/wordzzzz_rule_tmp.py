...
for mall in mall_list:
	...
	##自动调参第一步，使用所有最优参数
	xgb3 = XGBClassifier(learning_rate = 0.07,
	...
	result.to_csv(path + 'xgbsklearn_rule1_855.csv', index = False)
	print("End modelfit")

report = pd.DataFrame.from_records([df_report])
report.to_csv(path + 'xgbsklearn_rule1_855_train.csv', index = False)
